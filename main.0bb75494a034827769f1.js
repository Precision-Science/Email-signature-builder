 ...
 */const i=new WeakMap,o=e=>"function"==typeof e&&i.has(e),r=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,s=(e,t,n=null)=>{let i=t;for(;i!==n;){const t=i.nextSibling;e.removeChild(i),i=t}},a={},l={},c=`{{lit-${String(Math.random()).slice(2)}}}`,d=`\x3c!--${c}--\x3e`,u=new RegExp(`${c}|${d}`),p="$lit$";class h{constructor(e,t){this.parts=[],this.element=t;let n=-1,i=0;const o=[],r=t=>{const s=t.content,a=document.createTreeWalker(s,133,null,!1);let l=0;for(;a.nextNode();){n++;const t=a.currentNode;if(1===t.nodeType){if(t.hasAttributes()){const o=t.attributes;let r=0;for(let e=0;e<o.length;e++)o[e].value.indexOf(c)>=0&&r++;for(;r-- >0;){const o=e.strings[i],r=g.exec(o)[2],s=r.toLowerCase()+p,a=t.getAttribute(s).split(u);this.parts.push({type:"attribute",index:n,name:r,strings:a}),t.removeAttribute(s),i+=a.length-1}}"TEMPLATE"===t.tagName&&r(t)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(c)>=0){const r=t.parentNode,s=e.split(u),a=s.length-1;for(let e=0;e<a;e++)r.insertBefore(""===s[e]?m():document.createTextNode(s[e]),t),this.parts.push({type:"node",index:++n});""===s[a]?(r.insertBefore(m(),t),o.push(t)):t.data=s[a],i+=a}}else if(8===t.nodeType)if(t.data===c){const e=t.parentNode;null!==t.previousSibling&&n!==l||(n++,e.insertBefore(m(),t)),l=n,this.parts.push({type:"node",index:n}),null===t.nextSibling?t.data="":(o.push(t),n--),i++}else{let e=-1;for(;-1!==(e=t.data.indexOf(c,e+1));)this.parts.push({type:"node",index:-1})}}};r(t);for(const e of o)e.parentNode.removeChild(e)}}const f=e=>-1!==e.index,m=()=>document.createComment(""),g=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F \x09\x0a\x0c\x0d"'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.0.0");const $=(e,...t)=>new y(e,t,"html",j),C=e=>$`
<div class="gmail_signature" data-smartmail="gmail_signature">
  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'; font-size: 16px; line-height: 24px; font-weight: normal;">  
    ...
    ${(e=>{const t=!(!e.name.length&&!e.role.length),n=!(!e.email.length&&!e.phone.length);if(console.log("email: "+e.email.length),t&&n)return $`<div style="line-height: 14px;"><br></div>`})(e)}
    ${(e=>{if(e.length)return $`
    <div style="font-size: 14px; line-height: 21px;">
    ...
    ${(e=>{const t=!(!e.name.length&&!e.role.length),n=!(!e.email.length&&!e.phone.length);if(t||n)return $`<div style="line-height: 28px;"><br></div>`})(e)}
    ${(()=>$`
  <div>
...
</div>`,U=e=>{const t=new CustomEvent("update-data",{detail:{key:e.target.name,value:e.target.value}});document.body.dispatchEvent(t)},O={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;","`":"&#x60;","=":"&#x3D;"},I=document.querySelector("#root"),R={name:"",role:"",email:"",phone:""},P=()=>$`
...
<div class="row">
  <form class="col-12 col-md-6">
    ...
    <div class="field-row">
      ...
      <input type="email" name="email" @keyup=${e=>U(e)}>
    </div>
    <div class="field-row">
...
`,B=()=>{((e,t,n)=>{let i=M.get(t);void 0===i&&(s(t,t.firstChild),M.set(t,i=new _(Object.assign({templateFactory:k},n))),i.appendInto(t)),i.setValue(e),i.commit()})(P(),I);const e=document.querySelector("pre code"),t=document.querySelector("#preview div");e.innerHTML=(e=>String(e).replace(/[&<>"'`=\/]/g,e=>O[e]))(t.innerHTML)};document.body.addEventListener("update-data",e=>{const t=e.detail;R[t.key]=t.value,B()}),B(),console.log("Project started..."),"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./sw.js").then(e=>{console.log("SW registered: ",e)}).catch(e=>{console.log("SW registration failed: ",e)})}),document.querySelector(".js-warning").style.display="none"}]);
//# sourceMappingURL=main.0bb75494a034827769f1.js.map